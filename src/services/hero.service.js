const herois = [
   {
      ...
      class: "Warrior",
      skill: "Shout",
      story: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis convallis eu sapien et mollis. Nullam dapibus mollis ante a consectetur. Ut et convallis elit. Aliquam rhoncus tellus sapien, at lobortis."
   }, 
   {
      id: 2,
      name: "Fulano",
...
const delete__H__serv = () => {
   return herois.splice(herois.findIndex((hero) => hero.id === id), 1);
};
